      ...
      <div className="june_main_container">
        <div className="june_main_container_first_container">
          <h1 className="june_main_container_first_container_title">
            Our Design capabilites</h1>
         <div className="june_main_container_para"> <p className="june_main_container_first_container_para">Creating a beautiful UI/UX is easy but carefully designing a visually appealing, exceptionally engaging and consumer decision-impulsive site is the real game - that's what we do best.</p></div>
        </div>
        ...
        The fastest way to gather & analyse your requirements and take your product from concept to the actual design.
        </h3>
        </div>
        ...
        <h3 className="june_second_container_title_two">
        Reduce your time to market by swiftly moving your product design from pencil sketches to high-fidelity wireframes and mockups.
        </h3>
        </div>
        ...
        <div className="june_second_container">
        <div className="june_second_container_svg">
        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg></div>
        <h2 className="june_second_container_box_title_one">
        UI/UX Design
        </h2>
        <h3 className="june_second_container_title_two">
        We leverage our past UI/UX experience to bring simplicity to highly complex designs for user-friendliness and consumer engagement.
        </h3>
        </div>
        ...
        <h3 className="june_second_container_title_two">
        We have designed amazing experiences for websites and web applications across all platforms (desktop, mobile & tablets)..
        </h3>
        </div>
        ...
        <div className="june_third_container_first_box">
         ...
         <div className="june_third_container_first_box_svg_one"> <h2 className="june_third_container_first_box_first_title">Discovery</h2></div>
          </div>
          ...
          <div className="june_third_container_second_box_container">
            <div className="june_third_container_second_box_container_svg">
              ...
              <div className="june_third_container_second_box_container_svg_one"><h2 className="june_third_container_second_box_container_title">Wireframes</h2></div>
            </div>
          ...
          <div className="june_third_container_third_box_container">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layout"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>
           <div className="june_third_container_third_box_container_svg_one"> <h2 className="june_third_container_third_container_title">Build & Iterate</h2></div>
            </div>
          ...
          <div className="june_third_container_third_box_content_three">
            <div className="june_third_container_third_box_content_three_svg"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
            </div>
        ...
        <div className="june_fourth_container_box">
          ...
          Talk to us about your <span>challenges</span> and <span>we will bring an</span> incredible team.
          </h2>
          </div>
          <div className="june_fourth_container_box_button_cotainer">
          <button className="june_fourth_container_box_button">Let's Talk</button>
          </div>
        </div>
       <div className="june_main_container_images">
        <div className="june_first_container_images">
        <img className="june_first_container_images_one" src={pencilpic} alt="s" />
        <div className="june_main_container_images_content_main">
        <div className="june_second_container_images_one_content_container">
          <h1 className="june_main_container_images_content_One">Pencil sketch</h1>
          <p className="june_main_container_images_content_two">Back of the napkin designs</p>
          </div>
          </div>
        </div>
        <div className="june_first_container_images">
        <img className="june_first_container_images_one" src={imagepng2} alt="s" />
        <div className="june_main_container_images_content_main">
        <div className="june_second_container_images_one_content_container">
          <h1 className="june_main_container_images_content_One">Pencil sketch</h1>
          <p className="june_main_container_images_content_two">Back of the napkin designs</p>
        ...
        <div className="june_first_container_images">
        <img className="june_first_container_images_one" src={imagepng3} alt="s" />
        <div className="june_main_container_images_content_main">
        <div className="june_second_container_images_one_content_container">
          <h1 className="june_main_container_images_content_One">Pencil sketch</h1>
          <p className="june_main_container_images_content_two">Back of the napkin designs</p>
