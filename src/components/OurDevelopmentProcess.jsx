  ...
  const array = [
    {
      ...
      info: (
        <>
          ...
          First things first! We identify the scope of your project and take our
          time to understand your needs, business plans, and expectations. If
          you decide to develop an MVP first, we define its scope together.
          Thanks to that, we can give you a general development quotation and
          schedule.
        </>
      ),
    },
    {
      ...
      info: (
        <>
          ...
          your needs. At the end of this phase, we have wireframes of your app
          and the first design drafts, we’ve gathered development requirements,
          and prepared the basic documentation of the project. All set!
        </>
      ),
    },
    {
      ...
      info: (
        <>
          <span>Bringing your project idea into reality</span>
          Time to get to work! Once the project kicks off, we complete the
          designs, and start developing your application. Also, we see you as
          our development partner and that’s why we encourage you to be fully
          engaged throughout the project. The length of this phase depends on
          the app size and complexity. It usually takes us 3 months to create a
    ...
    },
    {
      ...
      info: (
        <>
          <span>Introducing your product to the market</span>
          Time to shine! As soon as your product is good to go, we take care of
          the deployment and release. Timing is crucial here: we make sure that
          every individual part of the system is released on schedule and works
          seamlessly, without any downtime. If it’s a mobile app, we take care
          of the app store listings as well. Once your application is live, we
    ...
    },
    {
      ...
      info: (
        <>
          <span>Taking good care of your product</span>
          The MVP is released, but your journey to success is only beginning!
          Here at Miquido, we aim at building long-term partnerships with our
          clients. We’ll help you improve your product based on the users’ real
          feedback, gather all the analytical data, or introduce additional
          features to your app that will leave your competition without a
          chance. So, let’s get to work!
        </>
      ),
    },
  ];
