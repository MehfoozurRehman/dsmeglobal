      ...
      <div className="pricing__fitted__team__content">
        <div className="pricing__fitted__team__content__entry">
          ...
          <ul className="pricing__fitted__team__content__entry__list">
            <li>
              Not looking to build a complete software department but need tech
              resources on demand.
            </li>
            <li>
              Offers a complete setup where you get access to the best tech and
              management talent (developers, UI/UX experts).
            </li>
          </ul>
          ...
          <ul className="pricing__fitted__team__content__entry__list">
            ...
            <li>With evolving specifications based on feedbacks on features</li>
            <li>
        ...
        <div className="pricing__fitted__team__content__entry">
          ...
          <ul className="pricing__fitted__team__content__entry__list">
            <li>
              Perfect solution when your current project initiatives need a few
              additional dedicated specialized resources.
            </li>
            <li>
          ...
          <ul className="pricing__fitted__team__content__entry__list">
            <li>With their own in-house IT teams and established processes.</li>
